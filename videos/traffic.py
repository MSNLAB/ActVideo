...
def traffic_dataloader(root=None, sequences=None, frames=None, transforms=None, **kwargs):
    kwargs_factory = {'collate_fn': _collate_fn, **kwargs}
    return DataLoader(TrafficDataset(root, sequences, frames, transforms), **kwargs_factory)
...
class TrafficDataset(DetectionDataset):
    ...
    def __init__(self, root=None, sequences=None, frames=None, transforms=None):
        ...
        super(TrafficDataset, self).__init__(frames, transforms)
